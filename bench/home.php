...
//this is to show the user that logged in
//print_r($_SESSION);
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class=" border-right" id="sidebar-wrapper" style="background-color:  rgba(0,0,102,0.7);">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="editprofile.php" class="list-group-item list-group-item-action bg-light">Edit profile</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Welcome <?php echo $deets['bus_name'];?></h1>
